...
describe('Title Case types', () => {
  test('Should infer the converted keys of a nested API response for every titleToX function', () => {
    const response = {
      'User Id': 42,
      'First Name': 'Ada',
      'Last Name': 'Lovelace',
    ...
    expectTypeOf(caseparser.titleToCamel(response)).toEqualTypeOf<{
      userId: number;
      firstName: string;
      lastName: string;
    ...
    expectTypeOf(caseparser.titleToPascal(response)).toEqualTypeOf<{
      UserId: number;
      FirstName: string;
      LastName: string;
      BillingAddress: { PostalCode: string; StreetName: string };
    ...
    expectTypeOf(caseparser.titleToSnake(response)).toEqualTypeOf<{
      user_id: number;
      first_name: string;
      last_name: string;
    ...
    expectTypeOf(caseparser.titleToDash(response)).toEqualTypeOf<{
      'user-id': number;
      'first-name': string;
      'last-name': string;
    ...
    expectTypeOf(caseparser.titleToUpperSnake(response)).toEqualTypeOf<{
      USER_ID: number;
      FIRST_NAME: string;
      LAST_NAME: string;
      BILLING_ADDRESS: { POSTAL_CODE: string; STREET_NAME: string };
    ...
    expectTypeOf(caseparser.titleToUpperDash(response)).toEqualTypeOf<{
      'USER-ID': number;
      'FIRST-NAME': string;
      'LAST-NAME': string;
      'BILLING-ADDRESS': { 'POSTAL-CODE': string; 'STREET-NAME': string };
    ...
    expectTypeOf(caseparser.titleToTrain(response)).toEqualTypeOf<{
      'User-Id': number;
      'First-Name': string;
      'Last-Name': string;
      'Billing-Address': { 'Postal-Code': string; 'Street-Name': string };
    ...
    expectTypeOf(caseparser.titleToDot(response)).toEqualTypeOf<{
      'user.id': number;
      'first.name': string;
      'last.name': string;
      'billing.address': { 'postal.code': string; 'street.name': string };
    ...
    expectTypeOf(caseparser.titleToSentence(response)).toEqualTypeOf<{
      'User id': number;
      'First name': string;
      'Last name': string;
      'Billing address': { 'Postal code': string; 'Street name': string };
